...
import { AdminObservabilityPanel } from '@/components/admin-observability-panel';
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm uppercase tracking-[0.25em] text-slate-500">Admin / Observability</p>
              <h1 className="text-3xl font-black text-slate-950">서비스 이용 현황</h1>
            </div>
